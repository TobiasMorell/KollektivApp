...
var style = __webpack_require__("qKn3");
var style_default = /*#__PURE__*/__webpack_require__.n(style);

// EXTERNAL MODULE: ./routes/kollexicon/style.css
var kollexicon_style = __webpack_require__("trQf");
var kollexicon_style_default = /*#__PURE__*/__webpack_require__.n(kollexicon_style);
...
// CONCATENATED MODULE: ./routes/kollexicon/KollexiconRule.js
...
var KollexiconRule_KollexiconRule = function (_Component) {
	_inherits(KollexiconRule, _Component);

	function KollexiconRule() {
		var _temp, _this, _ret;

		_classCallCheck(this, KollexiconRule);

		for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
			args[_key] = arguments[_key];
		}

		return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.toggleExpansion = function (e) {
			_this.setState({
				expanded: !_this.state.expanded,
				expansionAnimation: _this.state.expanded ? '' : 'expandAnimation'
			});
		}, _this.resetAnimation = function () {
			if (_this.icon) {
				var e = _this.icon.base;
			}
	...
	KollexiconRule.prototype.render = function render(_ref) {
		var _this2 = this;
		...
		if (this.state.expanded === undefined) this.state.expanded = expanded;

		this.resetAnimation();
		var animation = this.state.expansionAnimation;
		this.state.expansionAnimation = undefined;

		return Object(preact_min["h"])(
			'div',
			{ className: [kollexicon_style_default.a.foldOut, this.state.expanded ? kollexicon_style_default.a.expanded : ''].join(' ') },
			Object(preact_min["h"])(
				'div',
				{ className: [kollexicon_style_default.a.foldOutHeader].join(' '), onClick: this.toggleExpansion },
				Object(preact_min["h"])(
					'span',
					null,
					Object(preact_min["h"])(
					...
					Object(preact_min["h"])(
						Icon_default.a,
						{ ref: function ref(i) {
								return _this2.icon = i;
							}, className: animation ? kollexicon_style_default.a[animation] : '' },
						'expand_more'
					)
				)
			),
			Object(preact_min["h"])(
				'div',
				{ className: [kollexicon_style_default.a.ruleDescription].join(' ') },
				Object(preact_min["h"])(preact_markdown_default.a, { markdown: description.replace(/\t/g, '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;') })
			)
		);
	};

	return KollexiconRule;
}(preact_min["Component"]);


// CONCATENATED MODULE: ./routes/kollexicon/index.js
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return kollexicon_Shopping; });


function kollexicon__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function kollexicon__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function kollexicon__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var kollexicon__ref = Object(preact_min["h"])(
	'h2',
	{ className: ' mdc-typography--title' },
	'Kolleksikon Regler'
);

var kollexicon_Shopping = function (_Component) {
	kollexicon__inherits(Shopping, _Component);

	function Shopping() {
		var _temp, _this, _ret;

		kollexicon__classCallCheck(this, Shopping);

		for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
			args[_key] = arguments[_key];
		}

		return _ret = (_temp = (_this = kollexicon__possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
			rules: [],
			ruleSearch: ''
		}, _this._ruleList = function () {
			var relevantRules = _this.state.rules;
			if (_this.state.ruleSearch) relevantRules = _this.state.rules.filter(function (r) {
				return r.title.toLowerCase().includes(_this.state.ruleSearch.toLowerCase()) || r.description.toLowerCase().includes(_this.state.ruleSearch.toLowerCase());
			});

			return relevantRules.map(function (r) {
				return Object(preact_min["h"])(KollexiconRule_KollexiconRule, { title: r.title, description: r.description, expanded: _this.state.ruleSearch !== '' });
			});
		}, _temp), kollexicon__possibleConstructorReturn(_this, _ret);
	}

	Shopping.prototype.componentWillMount = function componentWillMount() {
		var _this2 = this;

		fetch('/beboere/assets/rules.json').then(function (r) {
			return r.json().then(function (j) {
				return _this2.setState({ rules: j });
			});
		});
	};

	Shopping.prototype.render = function render() {
		var rules = this._ruleList();
		...
		return Object(preact_min["h"])(
			...
			Object(preact_min["h"])(
				...
				Object(preact_min["h"])(
					'div',
					{ className: kollexicon_style_default.a.cardHeader },
					kollexicon__ref
				),
				Object(preact_min["h"])(
					'div',
					{ className: kollexicon_style_default.a.cardBody },
					Object(preact_min["h"])(TextField_default.a, { className: kollexicon_style_default.a.searchRules, type: 'text', onInput: Object(linkstate_es["a" /* default */])(this, 'ruleSearch'),
						label: 'S\xF8g efter en regel', helperText: 'Lad boksen v\xE6re tom for at vise alle regler.'
					}),
					rules
				)
			)
...
module.exports = {"searchRules":"searchRules__2Odz3","foldOutHeader":"foldOutHeader__5V8n_","ruleDescription":"ruleDescription__VRARz","tab":"tab__3CNhV","underline":"underline__1TWdN","foldOut":"foldOut__2OAf_","expanded":"expanded__2K6I7","expandAnimation":"expandAnimation__2P8OY","rotate":"rotate__r62Fn","cardBody":"cardBody__1Ma2H","cardMedia":"cardMedia__1L70s","cardHeader":"cardHeader__2y_02"};

/***/ })

};;
//# sourceMappingURL=2.chunk.df798.js.map